...
vim.lsp.show_line_diagnostics = true
...
vim.cmd [[
  map! <silent> <F4> <ESC>:NvimTreeToggle<CR>
...
require('lazy').setup({
  ...
  -- For showing the symbols in this file
  {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Note: This is where the actual change will start
      ...
      vim.keymap.set('n', '<C-s>', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
